...
import static securityz.Signin.isValid;


public class GMail_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/securityz/Images/gm (1).png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 230, 100));
...
public static boolean isValid(String email) 
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
                 ...
                 else if(password.getPassword().length < 7 || password.getPassword().length > 16 )
                 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GMail_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
